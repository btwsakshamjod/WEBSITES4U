...
<head>
  ...
  <style>
    ...
    * {
    ...
    .hero-title {
      width: min(100%, 41rem);
      max-width: min(41rem, calc(100vw - 2rem));
      font-size: clamp(2.9rem, 4.55vw, 4.75rem);
      line-height: 1.04;
    }
    ...
    .industry-card .industry-preview {
      margin-bottom: 10px;
    }
...
<body>
  ...
  <main id="home">
    <section class="relative overflow-hidden px-4 pb-8 pt-28 md:pt-32">
      ...
      <div class="hero-grid mx-auto grid max-w-[1370px] items-center gap-8 lg:gap-12">
        ...
        <div id="heroVisual" class="hero-stage reveal relative min-h-[470px] min-w-0 overflow-visible lg:min-h-[590px]">
          <img class="hero-art absolute object-contain" src="<?= e(setting('hero_image', 'assets/hero-device-mockup.png')) ?>" alt="Premium laptop and mobile website mockups for Websites4U">
        </div>
      </div>
    </section>
  ...
  <footer class="bg-cloud px-4 pb-6 pt-12 md:pt-14">
    <div class="mx-auto grid max-w-7xl gap-10 md:grid-cols-[1.05fr_1px_.85fr_.9fr_.85fr] md:gap-12">
      <div>
        <div class="text-3xl font-black tracking-tight text-ink"><?= e(setting('site_name', 'Websites4U')) ?></div>
        <p class="mt-7 max-w-xs text-lg font-medium leading-8 text-slate-600"><?= e(setting('footer_description', 'WEBSITES 4U builds modern, high-performance websites for Indian brands with clean UI, responsive design, fast loading speed, and conversion-focused development.')) ?></p>
        <div class="mt-6 flex items-center gap-4">
          <a href="<?= e(whatsapp_link()) ?>" class="grid h-12 w-12 place-items-center rounded-full bg-white text-emerald-500 shadow-lg shadow-slate-900/5" aria-label="WhatsApp"><svg class="h-5 w-5" viewBox="0 0 32 32" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M16.03 4C9.42 4 4.04 9.35 4.04 15.93c0 2.1.55 4.15 1.61 5.96L4 28l6.28-1.64a12.04 12.04 0 0 0 5.75 1.46C22.65 27.82 28 22.48 28 15.9 28 9.35 22.65 4 16.03 4Zm0 21.8c-1.75 0-3.47-.47-4.98-1.35l-.36-.22-3.72.98.99-3.62-.24-.38a9.8 9.8 0 0 1-1.5-5.28c0-5.46 4.4-9.9 9.82-9.9 2.63 0 5.1 1.03 6.95 2.9a9.82 9.82 0 0 1 2.88 6.98c0 5.45-4.4 9.89-9.84 9.89Zm5.4-7.4c-.3-.15-1.75-.86-2.02-.96-.27-.1-.47-.15-.67.15-.2.3-.77.96-.95 1.16-.18.2-.35.22-.65.07-.3-.15-1.25-.46-2.39-1.47a8.9 8.9 0 0 1-1.65-2.05c-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.53.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.48s1.07 2.88 1.22 3.08c.15.2 2.1 3.2 5.08 4.49.71.3 1.26.49 1.7.63.71.23 1.36.2 1.87.12.57-.08 1.75-.71 2-1.4.25-.68.25-1.27.17-1.4-.07-.12-.27-.2-.57-.35Z"/></svg></a>
          <a href="<?= e(setting('instagram_url', 'https://instagram.com/')) ?>" class="grid h-12 w-12 place-items-center rounded-full bg-white text-pink-500 shadow-lg shadow-slate-900/5" aria-label="Instagram"><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/><circle cx="17.5" cy="6.5" r="1.2" fill="currentColor"/></svg></a>
          <a href="#" class="grid h-12 w-12 place-items-center rounded-full bg-white text-blue-600 shadow-lg shadow-slate-900/5" aria-label="LinkedIn"><svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 9.5V19" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M10.5 19V13.8C10.5 11.9 11.7 10.7 13.4 10.7C15.1 10.7 16.3 11.9 16.3 13.8V19" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><path d="M10.5 11V19" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/><circle cx="6.5" cy="6" r="1.3" fill="currentColor"/><rect x="3" y="3" width="18" height="18" rx="4" stroke="currentColor" stroke-width="2"/></svg></a>
        </div>
      </div>
      <div class="hidden bg-slate-200 md:block"></div>
      <div><h4 class="flex items-center gap-4 text-2xl font-black text-ink"><i data-lucide="link" class="h-7 w-7 text-brand"></i> Quick Links</h4><div class="mt-8 grid gap-6 text-lg font-medium text-slate-600"><a class="flex items-center gap-4 hover:text-brand" href="#services"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Services</a><a class="flex items-center gap-4 hover:text-brand" href="#projects"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Projects</a><a class="flex items-center gap-4 hover:text-brand" href="#pricing"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Pricing</a><a class="flex items-center gap-4 hover:text-brand" href="#contact"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Contact</a></div></div>
      <div><h4 class="flex items-center gap-4 text-2xl font-black text-ink"><i data-lucide="monitor" class="h-7 w-7 text-brand"></i> Services</h4><div class="mt-8 grid gap-6 text-lg font-medium text-slate-600"><a class="flex items-center gap-4 hover:text-brand" href="#services"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Website Development</a><a class="flex items-center gap-4 hover:text-brand" href="#services"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Ecommerce</a><a class="flex items-center gap-4 hover:text-brand" href="#services"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> SEO Optimization</a><a class="flex items-center gap-4 hover:text-brand" href="#services"><i data-lucide="chevron-right" class="h-5 w-5 text-brand"></i> Mobile App UI</a></div></div>
      <div><h4 class="flex items-center gap-4 text-2xl font-black text-ink"><i data-lucide="phone-call" class="h-7 w-7 text-brand"></i> Contact</h4><div class="mt-8 grid gap-6 text-lg font-medium text-slate-600"><a class="flex items-center gap-4 hover:text-brand" href="<?= e(whatsapp_link()) ?>"><svg class="h-5 w-5 text-slate-700" viewBox="0 0 32 32" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M16.03 4C9.42 4 4.04 9.35 4.04 15.93c0 2.1.55 4.15 1.61 5.96L4 28l6.28-1.64a12.04 12.04 0 0 0 5.75 1.46C22.65 27.82 28 22.48 28 15.9 28 9.35 22.65 4 16.03 4Zm0 21.8c-1.75 0-3.47-.47-4.98-1.35l-.36-.22-3.72.98.99-3.62-.24-.38a9.8 9.8 0 0 1-1.5-5.28c0-5.46 4.4-9.9 9.82-9.9 2.63 0 5.1 1.03 6.95 2.9a9.82 9.82 0 0 1 2.88 6.98c0 5.45-4.4 9.89-9.84 9.89Zm5.4-7.4c-.3-.15-1.75-.86-2.02-.96-.27-.1-.47-.15-.67.15-.2.3-.77.96-.95 1.16-.18.2-.35.22-.65.07-.3-.15-1.25-.46-2.39-1.47a8.9 8.9 0 0 1-1.65-2.05c-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.53.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.48s1.07 2.88 1.22 3.08c.15.2 2.1 3.2 5.08 4.49.71.3 1.26.49 1.7.63.71.23 1.36.2 1.87.12.57-.08 1.75-.71 2-1.4.25-.68.25-1.27.17-1.4-.07-.12-.27-.2-.57-.35Z"/></svg> WhatsApp</a><a class="flex items-center gap-4 hover:text-brand" href="<?= e(setting('instagram_url', 'https://instagram.com/')) ?>"><svg class="h-5 w-5 text-slate-700" viewBox="0 0 24 24" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><rect x="3" y="3" width="18" height="18" rx="5" stroke="currentColor" stroke-width="2"/><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/><circle cx="17.5" cy="6.5" r="1.2" fill="currentColor"/></svg> Instagram</a><a class="flex items-center gap-4 hover:text-brand" href="mailto:<?= e(setting('email', 'hello@websites4u.in')) ?>"><i data-lucide="mail" class="h-5 w-5 text-brand"></i> <?= e(setting('email', 'hello@websites4u.in')) ?></a></div></div>
    </div>
    <div class="mx-auto mt-8 max-w-7xl border-t border-slate-200 pt-5 text-sm font-semibold text-slate-500">&copy; 2026 Websites4U. All rights reserved.</div>
  </footer>

  <a href="<?= e(whatsapp_link("Hi Websites4U, I want a premium website")) ?>" class="wa-pulse fixed bottom-5 right-5 z-50 hidden h-14 w-14 place-items-center rounded-full bg-emerald-500 text-white shadow-2xl shadow-emerald-500/30 transition hover:-translate-y-1 md:grid" aria-label="Chat on WhatsApp">
    <svg class="h-6 w-6" viewBox="0 0 32 32" fill="none" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M16.03 4C9.42 4 4.04 9.35 4.04 15.93c0 2.1.55 4.15 1.61 5.96L4 28l6.28-1.64a12.04 12.04 0 0 0 5.75 1.46C22.65 27.82 28 22.48 28 15.9 28 9.35 22.65 4 16.03 4Zm0 21.8c-1.75 0-3.47-.47-4.98-1.35l-.36-.22-3.72.98.99-3.62-.24-.38a9.8 9.8 0 0 1-1.5-5.28c0-5.46 4.4-9.9 9.82-9.9 2.63 0 5.1 1.03 6.95 2.9a9.82 9.82 0 0 1 2.88 6.98c0 5.45-4.4 9.89-9.84 9.89Zm5.4-7.4c-.3-.15-1.75-.86-2.02-.96-.27-.1-.47-.15-.67.15-.2.3-.77.96-.95 1.16-.18.2-.35.22-.65.07-.3-.15-1.25-.46-2.39-1.47a8.9 8.9 0 0 1-1.65-2.05c-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.53.15-.17.2-.3.3-.5.1-.2.05-.37-.02-.52-.08-.15-.67-1.61-.92-2.2-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.8.37-.27.3-1.04 1.02-1.04 2.48s1.07 2.88 1.22 3.08c.15.2 2.1 3.2 5.08 4.49.71.3 1.26.49 1.7.63.71.23 1.36.2 1.87.12.57-.08 1.75-.71 2-1.4.25-.68.25-1.27.17-1.4-.07-.12-.27-.2-.57-.35Z"/></svg>
  </a>
